...
| Go         | ![Go 深色](https://github.com/yuelinghuashu/moongate-theme/raw/HEAD/images/go-dark.png)         | ![Go 浅色](https://github.com/yuelinghuashu/moongate-theme/raw/HEAD/images/go-light.png)         |
...
👉 [查看完整设计系统文档](https://github.com/yuelinghuashu/moongate-theme/blob/HEAD/docs/DESIGN_SYSTEM.md)  
👉 [使用颜色令牌驱动博客或 UI 组件库](https://github.com/yuelinghuashu/moongate-theme/blob/HEAD/themes/moongate-colors.css)  
👉 [使用布局令牌（间距、排版、断点等）](https://github.com/yuelinghuashu/moongate-theme/blob/HEAD/themes/moongate-layout.css)
...
| Language   | Dark                                     | Light                                      |
| ---------- | ---------------------------------------- | ------------------------------------------ |
| JavaScript | ![JS Dark](https://github.com/yuelinghuashu/moongate-theme/raw/HEAD/images/javascript-dark.png) | ![JS Light](https://github.com/yuelinghuashu/moongate-theme/raw/HEAD/images/javascript-light.png) |
| Python     | ![Python Dark](https://github.com/yuelinghuashu/moongate-theme/raw/HEAD/images/python-dark.png) | ![Python Light](https://github.com/yuelinghuashu/moongate-theme/raw/HEAD/images/python-light.png) |
| Go         | ![Go Dark](https://github.com/yuelinghuashu/moongate-theme/raw/HEAD/images/go-dark.png)         | ![Go Light](https://github.com/yuelinghuashu/moongate-theme/raw/HEAD/images/go-light.png)         |
| Vue        | ![Vue Dark](https://github.com/yuelinghuashu/moongate-theme/raw/HEAD/images/vue-dark.png)       | ![Vue Light](https://github.com/yuelinghuashu/moongate-theme/raw/HEAD/images/vue-light.png)       |
...
👉 [View full documentation](https://github.com/yuelinghuashu/moongate-theme/blob/HEAD/docs/DESIGN_SYSTEM.md)
